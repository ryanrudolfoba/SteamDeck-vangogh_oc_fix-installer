...
elif [ $bios_version = F7A0116 ] || [ $bios_version = F7A0115 ] || [ $bios_version = F7A0113 ] || [ $bios_version = F7A0118 ]
then
...
sleep 2
if [ $kernel_version = 6.1.52-valve3-1-neptune-61 ] || [ $kernel_version = 5.13.0.valve37-1 ]
then 
